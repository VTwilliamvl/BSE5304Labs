...
plot(DPTI05$date,DPTI05$MF, ylab = "Available Water Extractable P (kg m-2 d-1)")
plot(DPTI05$date,DPTI05$DF, ylab = "Loss of Fertilizer in Runoff((kg m-2 d-1)")
...
# Build a dataframe for your DP Load model in TI Class 04,(you will need to do 
#this 5 times for TIC 1-4 where you will need the date, Qpred, and Average 
# Temperature
...
rm(list=c("MF","DF")) # Clean up the environment 
dev.off() #reset graphics device
plot(DPTI04$date,DPTI04$MF, ylab = "Available Water Extractable P (kg m-2 d-1)")
plot(DPTI04$date,DPTI04$DF, ylab = "Loss of Fertilizer in Runoff((kg m-2 d-1)")
...
# assign TIC to calc (remember TIC04 is in location 1 in the VSAsol$TIClass 
# table
# Setting range of Soil P values (MS) using the range given on page 7 of 
# Easton et al. 2007 (3.7-18.5mg/kg), then 
# Moore 1993… assume soil density is 2000kg/m^3 of soil
...
# al. 2007, pg 7. Moore suggests a linear relationship
# We will take care of all of TIClass 04 now as will so 
# it makes sense when you repeat for TI Classes 1-4
# You will use muTS_TI01 thru muTS_TI04 to finish this lab
#
QS= 3.0 # A guess using the middle of the range 1-5
...
# Build a dataframe for your DP Load model in TI Class 03,(you will need to do 
#this 5 times for TIC 1-4 where you will need the date, Qpred, and Average 
# Temperature
...
rm(list=c("MF","DF")) # Clean up the environment 
dev.off() #reset graphics device
plot(DPTI03$date,DPTI03$MF, ylab = "Available Water Extractable P (kg m-2 d-1)")
plot(DPTI03$date,DPTI03$DF, ylab = "Loss of Fertilizer in Runoff((kg m-2 d-1)")
...
# assign TIC to calc (remember TIC03 is in location 1 in the VSAsol$TIClass 
# table
# Setting range of Soil P values (MS) using the range given on page 7 of 
# Easton et al. 2007 (3.7-18.5mg/kg), then 
# Moore 1993… assume soil density is 2000kg/m^3 of soil
...
# al. 2007, pg 7. Moore suggests a linear relationship
# We will take care of all of TIClass 03 now as will so 
# it makes sense when you repeat for TI Classes 1-4
# You will use muTS_TI01 thru muTS_TI03 to finish this lab
#
QS= 3.0 # A guess using the middle of the range 1-5
TR=20   # reference Temperature from Table 2.
...
# Build a dataframe for your DP Load model in TI Class 02,(you will need to do 
#this 5 times for TIC 1-4 where you will need the date, Qpred, and Average 
# Temperature
...
rm(list=c("MF","DF")) # Clean up the environment 
dev.off() #reset graphics device
plot(DPTI02$date,DPTI02$MF, ylab = "Available Water Extractable P (kg m-2 d-1)")
plot(DPTI02$date,DPTI02$DF, ylab = "Loss of Fertilizer in Runoff((kg m-2 d-1)")
...
# assign TIC to calc (remember TIC02 is in location 1 in the VSAsol$TIClass 
# table
# Setting range of Soil P values (MS) using the range given on page 7 of 
# Easton et al. 2007 (3.7-18.5mg/kg), then 
# Moore 1993… assume soil density is 2000kg/m^3 of soil
...
# al. 2007, pg 7. Moore suggests a linear relationship
# We will take care of all of TIClass 02 now as will so 
# it makes sense when you repeat for TI Classes 1-4
...
# Build a dataframe for your DP Load model in TI Class 01,(you will need to do 
#this 5 times for TIC 1-4 where you will need the date, Qpred, and Average 
# Temperature
...
rm(list=c("MF","DF")) # Clean up the environment 
dev.off() #reset graphics device
plot(DPTI01$date,DPTI01$MF, ylab = "Available Water Extractable P (kg m-2 d-1)")
plot(DPTI01$date,DPTI01$DF, ylab = "Loss of Fertilizer in Runoff((kg m-2 d-1)")
...
# assign TIC to calc (remember TIC01 is in location 1 in the VSAsol$TIClass 
# table
# Setting range of Soil P values (MS) using the range given on page 7 of 
# Easton et al. 2007 (3.7-18.5mg/kg), then 
# Moore 1993… assume soil density is 2000kg/m^3 of soil
...
# al. 2007, pg 7. Moore suggests a linear relationship
# We will take care of all of TIClass 01 now as will so 
# it makes sense when you repeat for TI Classes 1-4
...
plot(DPLT$date,DPLT$LT, type="l",ylim=c(0,7), ylab = "Average Watershed P Export (kg d-1)")
